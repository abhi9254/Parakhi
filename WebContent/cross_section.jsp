					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle "
							...
							<ul class="dropdown-menu">
								...
								<li><a href="#" data-toggle="modal" data-target="#myModal">New Project</a></li>
							</ul></li>
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown" data-hover="dropdown" data-delay="0"
							...
							<ul class="dropdown-menu">
								<li><a target="_blank"
									href="https://docs.google.com/spreadsheets/d/16Fy4uF1MVpAkoW-ads6XabQnuOK2HJQ63mn7FUnNjkE"
									>View Sheet</a></li>
								<li><a href="" data-toggle="modal" data-target="#myModal2">Rerun Sheet</a></li>
							</ul></li>
	...
	<div class="container">
		<div class="row">
			<div class="panel panel-warning">
				<div class="panel panel-heading">CROSS SECTION / SAMPLE</div>
				<div class="panel panel-body">
					<form action="Cross_section_mt" method="post">
							<input type="text" class="form-control" name="database" value="db_gold" placeholder="Database"><br> 
							<input type="text" class="form-control" name="table" value="gold_product_sku" placeholder="Table"><br> 
							Columns: <br>
							<input type="checkbox" name='cols' value="dept_nm" checked>Dept_nm<br>
							<input type="checkbox" name='cols' value="gma_nm" checked>Gma_nm<br>
							<input type="checkbox" name='cols' value="age_grp">Age_grp<br>
							<input type="checkbox" name='cols' value="gender">Gender<br>
							<br>
						</div>
						<input type="submit" value="Brinng it" class="btn btn-warning">
					</form>
				</div>
			</div>
		</div>
