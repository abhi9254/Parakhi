...
<body>
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								<li><a target="_blank"
									...
									>View Sheet</a></li>
								<li><a href="index.jsp" data-toggle="modal" data-target="#myModal2">Rerun Sheet</a></li>
							</ul></li>
	...
	<h4>
		...
		<%=System.getProperty("user.home")%></h4><br>
	<h4>Rerunning Sheet..</h4>
	<h4>Complete</h4>
</div>

<%	
String sheet_id = "16Fy4uF1MVpAkoW-ads6XabQnuOK2HJQ63mn7FUnNjkE";
String worksheet_id= request.getParameter("s_id");
String q_range= worksheet_id+"!"+request.getParameter("q_range");
String op_range= worksheet_id+"!"+request.getParameter("op_range");
	SheetsAPI ob = new SheetsAPI();
	ob.rerunSheet(sheet_id, q_range, op_range);
